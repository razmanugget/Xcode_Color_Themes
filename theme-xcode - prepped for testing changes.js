...
.ace-xcode {background-color: #282A36;color: #CDCCCC} <done>
...
.ace-xcode .ace_marker-layer .ace_bracket {margin: -1px 0 0 -1px;border: 1px solid #FFCC68} <done - bracket when highlighting>
...
.ace-xcode .ace_entity.ace_other.ace_attribute-name {color: #30DC23} <testing as green - ok>
.ace-xcode .ace_support.ace_constant {color: #30DC23} <testing as green ok>
.ace-xcode .ace_support.ace_function {color: #2B74CC} <done - could breakup more - subscript, print, (return), (func calls)>


.ace-xcode .ace_fold {background-color: #565A6D;border-color: #7F7F7F} <done>
.ace-xcode .ace_entity.ace_name.ace_tag,.ace-xcode .ace_support.ace_class,.ace-xcode .ace_support.ace_type {color: #30DC23} <testing as green ok>
.ace-xcode .ace_storage {color: #2B74CC} <done - Int, String>
.ace-xcode .ace_string {color: #59C29C} <done>
.ace-xcode .ace_string.ace_regexp {color: #30DC23;} <green added but does nothing?? - ok>
